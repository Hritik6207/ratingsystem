...
?>
<title>Star Rating-Your Opinion matters!!</title>
...
<div class="container">		
	...
	<button id="rProduct" type="button" onclick=abc() class="btn btn-success" <?php if(!empty($_SESSION['userid']) && $_SESSION['userid']){ echo 'login';} ?>>Login</button></div>
	<?php
